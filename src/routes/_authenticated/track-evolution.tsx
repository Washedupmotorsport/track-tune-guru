...
import { CloudRain, Thermometer, Wind, Activity, Gauge, Disc, AlertTriangle, Sparkles, Plus, Trash2, CloudSun, Droplets, Flame, Snowflake, ExternalLink, Globe } from "lucide-react";
