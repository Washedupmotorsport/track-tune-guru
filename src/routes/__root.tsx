...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Racing-Engineer" },
      { name: "twitter:title", content: "Racing-Engineer" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&display=swap" },
    ],
    scripts: [
      {
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    // Only enable the offline shell on a published production origin.
    // In preview / dev / iframes, an active SW caches stale HTML that
    // references old JS chunks, causing 404s and reload flashing.
    const host = window.location.hostname;
    const isProd = host.endsWith(".bolt.host") || host.endsWith(".lovable.app");
    if (isProd) {
