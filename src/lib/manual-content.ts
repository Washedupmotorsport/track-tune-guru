...
export const MANUAL_SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    title: "Confidence",
    group: "Driver",
    route: "/driver-hub?tab=confidence",
  ...
  },
  {
    ...
    group: "Driver",
    route: "/driver-hub?tab=behaviours",
