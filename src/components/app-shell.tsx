      ...
      <header className="sticky top-0 z-30 backdrop-blur-md bg-background/80 border-b border-border">
        <div className="mx-auto max-w-[1400px] px-4 h-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/pitwall" className="hidden lg:inline-flex items-center text-xs font-mono uppercase tracking-widest text-muted-foreground hover:text-primary">
              <Radio className="w-4 h-4 mr-1" /> Pit wall
            </Link>
